  ...
  return (
    <main className="px-8 py-12 max-w-4xl mx-auto">
      ...
      <div className="flex flex-col gap-6">
        <div className="p-6 border border-gray-200 rounded-lg flex gap-4 items-start">
          <Scale size={32} className="text-[#1a1a2e] shrink-0" />
          <div>
        ...
        <div className="p-6 border border-gray-200 rounded-lg flex gap-4 items-start">
          <Briefcase size={32} className="text-[#1a1a2e] shrink-0" />
          <div>
        ...
        <div className="p-6 border border-gray-200 rounded-lg flex gap-4 items-start">
          <Users size={32} className="text-[#1a1a2e] shrink-0" />
          <div>
